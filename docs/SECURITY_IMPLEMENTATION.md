...
**Key Difference:**  is a complete authentication library, BetterPay is a payment library that provides security hooks for user apps to integrate their own auth.
