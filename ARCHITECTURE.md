...
**Foundation:** Bukan greenfield. BetterPay dibangun di atas `payment gateway core` () yang sudah production-grade dengan 6 provider adapter terintegrasi, state machine, circuit breaker, reconciliation worker, dan replay protection.
